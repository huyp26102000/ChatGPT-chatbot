...
requests.get(URL_OUTPUT_MESS)

# # get authentication from MessengerWebhook
requests.get(URL_OUTPUT_ZALO)
...
def consume_messages_zalo():
    ...
    def callback(ch, method, properties, body):
        ...
        if response.status_code == 200:
            ...
            print('Request failed with status code zalo:', response.status_code)
...
def consume_messages_mess():
    ...
    def process_message_mess(ch, method, properties, body):
        ...
        if response.status_code == 200:
            ...
            print('Request failed with status code messenger:', response.status_code)
        time.sleep(time_sleep)
